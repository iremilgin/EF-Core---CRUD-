...
namespace EfCRUDOdev.Context
{
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<KritikSeviyeBilgileri> KritikSeviyeBilgileris { get; set; } = null!;
        ...
        public virtual DbSet<EfCRUDOdev.Models.Region> Regions { get; set; } = null!;
        ...
        public virtual DbSet<SiparislerTablsou> SiparislerTablsous { get; set; } = null!;
        ...
        public virtual DbSet<VCondimentsTop5> VCondimentsTop5s { get; set; } = null!;
        public virtual DbSet<VwCalisanSipari> VwCalisanSiparis { get; set; } = null!;
        public virtual DbSet<VwEnPahalıCondiment> VwEnPahalıCondiments { get; set; } = null!;
        public virtual DbSet<VwMusteriAlısveri> VwMusteriAlısveris { get; set; } = null!;
        public virtual DbSet<VwSiparisUrunSayisi> VwSiparisUrunSayisis { get; set; } = null!;
        public virtual DbSet<VwUrunlerKatSup> VwUrunlerKatSups { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data source=ERDEMPC\\ERDEM;initial catalog=Northwind;integrated security=true");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<KritikSeviyeBilgileri>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("KritikSeviyeBilgileri");
            ...
            modelBuilder.Entity<Musteriler>(entity =>
            {
                entity.HasKey(e => e.MusteriId)
                    .HasName("PK__Musteril__726244712F4B7BE4");
            ...
            modelBuilder.Entity<EfCRUDOdev.Models.Region>(entity =>
            {
            ...
            modelBuilder.Entity<SiparislerTablsou>(entity =>
            {
                entity.HasNoKey();

                entity.ToTable("SiparislerTablsou");

                entity.Property(e => e.BirimFİyati).HasColumnType("money");

                entity.Property(e => e.MusteriId).HasColumnName("MusteriID");

                entity.Property(e => e.SiparisId).HasColumnName("SiparisID");

                entity.Property(e => e.ToplamFiyati)
                    .HasColumnType("money")
                    .HasComputedColumnSql("([adet]*[birimfiyati])", false);

                entity.Property(e => e.Urun)
                    .HasMaxLength(20)
                    .IsUnicode(false);

                entity.Property(e => e.YemekSirketi)
                    .HasMaxLength(20)
                    .IsUnicode(false);
                ...
                entity.HasOne(d => d.Musteri)
                    ...
                    .HasConstraintName("FK__Siparisle__Muste__1DB06A4F");
            });
            ...
            modelBuilder.Entity<VCondimentsTop5>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("v_condiments_top5");
            ...
            modelBuilder.Entity<VwCalisanSipari>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("vw_CalisanSiparis");
            ...
            modelBuilder.Entity<VwEnPahalıCondiment>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("vw_EnPahalıCondiments");
            ...
            modelBuilder.Entity<VwMusteriAlısveri>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("vw_MusteriAlısveris");
            ...
            modelBuilder.Entity<VwSiparisUrunSayisi>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("vw_siparis_urun_sayisi");

                entity.Property(e => e.OrderId).HasColumnName("OrderID");
            });

            modelBuilder.Entity<VwUrunlerKatSup>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("vw_UrunlerKatSup");
